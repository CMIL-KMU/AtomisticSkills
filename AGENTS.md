...
- **Workflows** (`.agents/workflows/`): Scientific protocol references for composing Anvil Campaigns; they do not own execution state.

For campaign work, use Anvil as the state authority and consult workflow documents only for scientific guidance. For a focused analysis, use the relevant skill directly.
